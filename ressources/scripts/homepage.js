...
let ingredientList = getIngredients(searchedRecipes);
let applianceList = getAppliance(searchedRecipes);
let ustensilsList = getUstensils(searchedRecipes);
...
//RENDER RECIPE CARD
export function renderRecipe(listRecette) {
